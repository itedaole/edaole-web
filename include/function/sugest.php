 ...
 * @return array
 */
function uploads($save_path, $size = -1, $rule = 'uniqid') {
...
function dz_user_add(){
   return true;
}

function hl_user_add(){
   return true;
}
/**
 * 得到操作系统信息
...
function get_system() {
	...
	function is_zhou_pass(){
	   return true;
	}

	function is_user_edit(){
	   return true;
	}
